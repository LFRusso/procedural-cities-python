...
def _plotMinorRoads(edges, ax):
    ...
    scalar_countour = StrokeScalar(artists_contour, 30)
    scalar = StrokeScalar(artists, 15)
...
def _plotMinorHighways(edges, ax):
    # Plotting contours
    ...
    scalar = StrokeScalar(artists, 25)
